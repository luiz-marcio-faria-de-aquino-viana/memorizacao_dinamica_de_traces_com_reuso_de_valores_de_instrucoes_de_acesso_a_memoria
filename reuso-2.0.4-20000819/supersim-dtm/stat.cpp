...
void CStat::AddInstrCount(uword_t _execunit, uword_t _instop)
{
  AddInstrCount(_execunit, _instop, (long)1L, IC_NORMAL);
}
...
void CStat::AddInstrCount(uword_t _execunit, uword_t _instop, long _numinstr)
{
  AddInstrCount(_execunit, _instop, _numinstr, IC_NORMAL);
}
...
// _tpfaixa - tipo de faixa (0-NORMAL, 1-INST_REUSE, 2-TRACE, 3-TRACE_REUSE)
void CStat::AddInstrCount(statistics_t * _stats)
{
  AddInstrCount(_stats, IC_NORMAL);
}
...
{
  AddTraceSz(_tracesz, _tpfaixa, NULL);
}
