...
CFetchBufItem* CFetchBuf::InsertItem( uword_t _addr,
				      ...
				      bool_t _dslot)
{
  return InsertItem(_addr, _inst, _dslot, FALSE, FALSE, 0);
}
...
CFetchBufItem* CFetchBuf::InsertItem( uword_t _addr,
				      ...
				      bool_t _oblevel)
{
  return InsertItem(_addr, _inst, _dslot, _oblevel, FALSE, 0);
}
...
CFetchBufItem* CFetchBuf::InsertItem( uword_t _addr,
				      ...
				      bool_t _bdep)
{
  return InsertItem(_addr, _inst, _dslot, _oblevel, _bdep, 0);
}
