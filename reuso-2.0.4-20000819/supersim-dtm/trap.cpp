...
int CTrap::Truncate()
{
  ...
  printf("CTrap::Truncate - Ret=%d", ret);
...
int CTrap::Ftruncate()
{
  ...
  printf("CTrap::Ftruncate - Ret=%d", ret);
...
int CTrap::SigVec()
{
  ...
  ret = 0;
  printf("CTrap::SigVec - sig=%d, vec=%ld, oldvec=%ld, Ret=%d", sig, (uword_t)oldvec, (uword_t)vec, ret);
...
int CTrap::SigBlock()
{
  ...
  // ret = sigblock(mask);
  ret = 0;
  printf("CTrap::SigBlock - mask=%d, Ret=%d", mask, ret);
...
int CTrap::Ioctl()
{
  ...
  fd = (int) RdIReg(O0);
  cmd = (int) RdIReg(O1);
  arg = (uword_t) RdIReg(O2);
  
  ret = ss_ioctl(fd, cmd, (char*) arg);
  printf("CTrap::Ioctl - Ret=%d", ret);
...
int CTrap::Getrlimit()
{
  ...
  printf("CTrap::Getrlimit - Ret=%d", ret);
  WrIReg(O0, (unsigned) ret);
  return(TRUE);
}
...
int CTrap::Setrlimit()
{
  ...
  printf("CTrap::Setrlimit - Ret=%d", ret);
  WrIReg(O0, (unsigned) ret);
  return(TRUE);
}
...
int CTrap::Mmap()
{
  ...
  printf("CTrap::Mmap - addr=%ld, len=%ld, prot=%d, flags=%d, off=%ld, fd=%d", (uword_t)&addr, (uword_t)len, prot, flags, (uword_t)&off, fd);
...
int CTrap::GetHostId()
{
  ...
  printf("CTrap::GetHostId - Ret=%ld", ret);
...
int CTrap::Mount()
{
  ...
  printf("CTrap::Mount - specialfile=%ld, dir=%ld, rwflag=%d", (uword_t)specialfile, (uword_t)dir, rwflag);
  return(TRUE);
}
...
int CTrap::Gettimeofday()
{
  ...
  printf("CTrap::Gettimeofday - Ret=%d", ret);
