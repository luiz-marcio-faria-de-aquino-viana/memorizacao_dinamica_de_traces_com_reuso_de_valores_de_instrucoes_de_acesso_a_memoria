...
void CStat::AddInstrCount(uword_t _execunit, uword_t _instop, long _numinstr = 1, int _tpfaixa = IC_NORMAL)
{
...
// _tpfaixa - tipo de faixa (0-NORMAL, 1-INST_REUSE, 2-TRACE, 3-TRACE_REUSE)
void CStat::AddInstrCount(statistics_t * _stats, int _tpfaixa = IC_NORMAL)
{
...
void CStat::AddTraceSz(long _tracesz, int _tpfaixa)
{
...
void CStat::ShowCDF()
{
  ...
  char *tpFaixa [4] = { "IC_NORMAL", "IC_INST_REUSE", "IC_TRACE", "IC_TRACE_REUSE" };
  char *tpTerm [6] = { "TFN_OVERFLOW", "TFN_DELAYINST", "TFN_NVALID", "TFN_NREDUNDANT", "TFN_TRACE", "TFN_LOADSTORE" };
...
void CStat::Reset()
{
  ...
  TLD_traces_following_reused_load = 0;   // total de traces servidos por load reusado
